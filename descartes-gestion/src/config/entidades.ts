...
export const entidades: Record<string, EntidadConfig> = {
  ...
  articulos: {
    ...
    campos: [
      ...
      { key: 'impuestoCodigo', label: 'Impuesto', type: 'select', optionsSource: 'impuestos' },
      { key: 'proveedorHabitual', label: 'Proveedor habitual', type: 'select', optionsSource: 'proveedores' },
      { key: 'activo', label: 'Activo', type: 'checkbox' },
    ],
  },
  clientes: {
