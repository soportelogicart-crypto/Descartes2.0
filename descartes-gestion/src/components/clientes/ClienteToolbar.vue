  ...
  <div class="toolbar">
    <div class="toolbar-group">
      ...
      <button
        type="button"
        class="tool-btn"
        :disabled="loading || !puedeEditar || modoEdicion || !hayCliente"
        title="Modificar"
      ...
      <button
        type="button"
        class="tool-btn"
        :disabled="loading || !puedeEliminar || !hayCliente"
        title="Borrar"
        @click="$emit('borrar')"
      >
    ...
    <div class="toolbar-group">
      <button type="button" class="tool-btn" :disabled="loading || !hayCliente" title="Estadistica" @click="$emit('estadistica')">
        <ToolIcon name="estadistica" />
        <span>Estadistica</span>
      </button>
      <button type="button" class="tool-btn" :disabled="loading || !hayCliente" title="Consumo" @click="$emit('consumo')">
        <ToolIcon name="consumo" />
        <span>Consumo</span>
      </button>
      <button type="button" class="tool-btn" :disabled="loading || !hayCliente" title="Contactos" @click="$emit('contactos')">
        <ToolIcon name="contactos" />
        <span>Contactos</span>
      </button>
      <button type="button" class="tool-btn" :disabled="loading || !hayCliente" title="Intereses" @click="$emit('intereses')">
        <ToolIcon name="intereses" />
        <span>Intereses</span>
      </button>
      <button type="button" class="tool-btn" :disabled="loading || !hayCliente" title="Direccion" @click="$emit('direccion')">
        <ToolIcon name="direccion" />
        <span>Direccion</span>
      </button>
    </div>
